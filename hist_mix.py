...
purity_26 = round(100*(alpha_26/(other_26 + not_vertex_26)),2)
effi_26 = round(100*(alpha_26/522),1)
...
alpha_27 = searchnum(alpha_result,2,7)
other_27 = searchnum(other_result,2,7)
not_vertex_27 = searchnum(not_vertex_result,2,7)
purity_27 = round(100*(alpha_27/(other_27 + not_vertex_27)),2)
effi_27 = round(100*(alpha_27/522),1)
print('alpha27;'+str(alpha_27))
print('other27;'+str(other_27))
print('not_vertex27;'+str(not_vertex_27))
print('purity26:'+str(purity_27))
print('effi_26;'+str(effi_27))
